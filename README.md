...
```bash
git clone https://github.com/LearnRoboticsWROS/aliyu_my_xarm6.git
```

b. Main application node
```bash
git clone https://github.com/LearnRoboticsWROS/aliyu_my_xarm6_app.git
```
