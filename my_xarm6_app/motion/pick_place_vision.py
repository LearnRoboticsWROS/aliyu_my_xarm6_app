...
class PickPlaceVisionNode(Node):
    ...
    def get_object_position_base(self, object_name):
        ...
        # Trasforma punto da camera_optical_link → link_base
    ...
    def execute_sequence(self):
        ...
        if grasp_cube:
            ...
            self.pick_and_place('red_cube', 'link_0', grasp_cube, pre_cube, post_cube, place_cube, (roll,pitch,yaw))
