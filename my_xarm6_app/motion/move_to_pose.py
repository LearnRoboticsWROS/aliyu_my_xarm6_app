...
class MoveToPoseNode(Node):
    def __init__(self):
        ...
        # 2️⃣ Client for action controller
        ...
        # 3️⃣ Timer per eseguire una sola volta
    ...
    def ik_response_callback(self, future):
        ...
        # ✅ Costruisci il goal per il controller
