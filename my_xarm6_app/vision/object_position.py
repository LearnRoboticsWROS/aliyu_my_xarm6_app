...
class ObjectPositionNode(Node):
    ...
    def rgb_callback(self, msg):
        """Riceve immagine RGB e calcola posizione 3D di oggetti in base al colore."""
        ...
        # Trova centroidi e mostra risultati
